    ...
    <div class="flex-center position-ref">
        <div class="content">
            <div class="title m-b-md">
                ...
                <p><strong>Code Golf</strong> is an exercise where you are tasked with completely a problem in as few characters as possible. I primarily am a php and javascript developer so those will be the languages we will primarily work with.</p>
                <br>
